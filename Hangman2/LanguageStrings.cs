    ...
    class LanguageStrings
    {
        public static void Swedish()
        {
            string swedish = "Skriv in namn:" + Environment.NewLine +
             ...
             "4. Avsluta spel." + Environment.NewLine +
             ...
             "4. Avsluta spelet." + Environment.NewLine +
             ...
             "Avslutar spelet." + Environment.NewLine +
             "3. Visa Poängligan" + Environment.NewLine +
             "Poängligan:" + Environment.NewLine +
        ...
        public static void Northlandish()
        {
            ...
            "4. Lägg utåa." + Environment.NewLine +
            ...
            "Slut å' kö!" + Environment.NewLine +
            "3. Storfräsarna" + Environment.NewLine +
            "Storfräsarna:" + Environment.NewLine +
            "Tjoffa te 'nter fö å se första menyn"; 
        ...
        public static void English()
        {
            ...
            "2. How to." + Environment.NewLine +
            "4. Quit game." + Environment.NewLine +
            ...
            "Quitting game." + Environment.NewLine +
            "3. Highscore" + Environment.NewLine +
            "Highscore:" + Environment.NewLine +
